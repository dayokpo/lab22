<?php
 /**
  * Title: Template 404
  * Slug: gigantic-construction/template-404
  * Categories: template
  * Inserter: false
  */
?>
...
<p class="has-text-align-center"><?php echo esc_html__( 'This page could not be found. Maybe try a search?', 'gigantic-construction' ); ?></p>
<!-- /wp:paragraph -->

 ...
 * Slug: gigantic-construction/template-archive
 * Categories: template
 * Inserter: false
 */
?>
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"gigantic-construction"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
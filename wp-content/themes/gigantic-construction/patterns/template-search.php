 ...
 * Slug: gigantic-construction/template-search
 * Categories: template
 * Inserter: false
 */
?>
...
<p class="has-x-small-font-size"><?php esc_html_e( '.', 'gigantic-construction' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-center has-large-font-size"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Try another search?', 'gigantic-construction' ); ?></p>
<!-- /wp:paragraph -->
